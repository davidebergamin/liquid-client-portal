...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Liquid — Mood Board" },
      { name: "description", content: "Scegli lo stile del tuo nuovo sito da fotografo di matrimonio." },
      { property: "og:title", content: "Liquid — Mood Board" },
